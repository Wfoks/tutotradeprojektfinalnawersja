...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('strona', '0020_rename_recipient_message_recipent'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='thread',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='strona.threadmodel'),
        ),
    ]
